...
<div class="st-templates-list">
    <?php foreach( $templates as $template ): ?>
        <?php $is_theme_included = in_array( $template->portfolio_download_id, $theme_included); ?>
        <div class="st-template <?php echo $is_theme_included ? 'st-theme-included' : '' ?>" data-id="<?php echo esc_attr( $template->portfolio_download_id ) ?>">
            ...
            <div class="st-template__actions">
                <?php if( class_exists( 'RevSlider' ) ): ?>
                    <a class="button button-secondary st-install-template" href="#" data-download="<?php echo esc_attr( $template->portfolio_download_id ) ?>">Import</a>
                <?php endif; ?>
